...
Made from the source code of [Devil 🇮🇳](t.me/luciifeermorningstar)

Special thanks to [this person](t.me/denver02) for helping me.

Deploy a bot like me [now](www.github.com/DevilGroupManagerV2/DevilGroupManagerV2)

Watch [video tutorial](https://www.youtube.com/watch?v=gXXFpTAk6Vo&feature=youtu.be) on deploying me.

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/Devil_GroupManagerBot?startgroup=true).
"""
